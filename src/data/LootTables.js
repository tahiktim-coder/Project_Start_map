...
const LOOT_POOLS = {
    ...
    // Weight will be the baseline against which other things compete
    NULL_RESULT: [
        { type: 'RESOURCE', val: 'METALS', min: 1, max: 3, weight: 50, log: "Core Sample: Trace Metals found." },
        { type: 'RESOURCE', val: 'ENERGY', min: 1, max: 3, weight: 50, log: "Atmos Sample: Trace Ions found." }
    ],

    // 1. Metals Tiers
    METALS_SCARCE: [
        { type: 'RESOURCE', val: 'METALS', min: 1, max: 5, weight: 20 }
    ],
    METALS_COMMON: [
        { type: 'RESOURCE', val: 'METALS', min: 10, max: 25, weight: 60 }
    ],
    METALS_RICH: [
        { type: 'RESOURCE', val: 'METALS', min: 40, max: 80, weight: 100 },
        { type: 'RESOURCE', val: 'METALS', min: 20, max: 40, weight: 20 } // Extra fallback
    ],
