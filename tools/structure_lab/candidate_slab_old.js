/* GRAVEYARD — the Structure, drawn by its dead.
   Forty-one thousand hulls. The rings are made of ships; a river of them comes in from the left and ends at the lit
   edge; near the slab they lie in perfect rows, as if filed — dark type on a lit page — and the edge reads them, one
   row at a time. The slab itself is pure: flat black, straight edges, no noise. The only warm pixel is you. */
'use strict';
...
module.exports = { name: 'final', look: LOOK, render, renderVista };
