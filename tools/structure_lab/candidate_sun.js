/* SUN candidate — the false sun at the end of the heading (docs/CANON.md §3).
   A white core, a gold corona that breathes, faint rays that turn very slowly, a soft limb, a halo ring — a home star, the lure.
   One violet thing only: the reading, a band of light that sweeps the face left to right and repeats (the disc page's sweep).
   Inside the light, the graveyard: a few small dark hulls drifting across the face like planets in transit. Never many. */
'use strict';
...
module.exports = { name: 'sun', look: LOOK, render, renderVista };
