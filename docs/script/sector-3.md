...
#### The card when it ends «TheThrow.js · play»
_Also the log lines. Mira says the line; A.U.R.A. says hers if Mira is dead._

- NO SOURCE · NOBODY ABOARD IS LOOKING AT THIS «TheThrow.js · line 104»
- skip › «TheThrow.js · line 106»
- SECTOR 3 Generated. — no name. no stars. «TheThrow.js · line 116»
...
- Nobody answers. «TheThrow.js · line 173»
...
_In one wreck in this sector. The last entry in a captain's log. The ship's number is higher than ours, and it is a hundred years old. In the cargo hold it is called: Captain's Log (sent less far back)._
...
- SIGNAL INTERFERENCE: [name] was a phantom reading. The signal dissolves. «NavView.js · line 175»
- [name]: "The readings just... vanished. The signal is playing games with our instruments." «NavView.js · line 180»
- ⚠ SIGNAL INTERFERENCE «NavView.js · line 190»
- Phantom reading dissolved. Sensor recalibrating... «NavView.js · line 191»

## Never played: the corridor film «StoryReel.js · corridor»
_Written for this sector, but no code plays it._
_Source on screen: BRIDGE DISPLAY · THE FILM, WITH EVERY TRANSPONDER WE CAN HEAR_
_Counter on screen: HULLS ON THIS HEADING_

*Mira puts the briefing film back up.*  
*Then she lays the real signals over it.*  
*They were not sent everywhere. They were all sent this way.*  
*All of them. Toward one thing.*  

## The sector's own trouble: INTERFERENCE «SectorConfig.js · 3.hazard»
_Hundreds of dead transponders on the scan band scramble readings_

On a long-range scan:
- A.U.R.A.: "Interference on the scan band, Commander. Hundreds of dead transponders. I would not trust the air reading until we are closer." «SectorConfig.js · 3.hazard.onScan»
...
1. **Full repair.** — -25 Salvage. Repairs a damaged deck and braces the drive: +4 Energy saved on the next sector jump. _(locked: Needs 25 Salvage)_
   ...
   ↳ or: Full repair. The [deck] is working again and the drive is braced. -25 Salvage.  
2. **Quick patch on the frame.** — -10 Salvage. Braces the drive: +4 Energy saved on the next sector jump. Nothing else is fixed. _(locked: Needs 10 Salvage)_
...
3. **Fly as we are.** — Nothing spent. 40% chance a deck gets damaged.
   ...
   ↳ or: A section of hull gave way. The [deck] is damaged. Vance: 'I warned you.'  
